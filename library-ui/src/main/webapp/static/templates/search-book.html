...
<input ng-model="book.query" id="query" class="form-control" placeholder="Title" value="book" ng-change="book.submit()"/>
...
<td>
<a href="#/search/{{book.query}}/{{parseInt(book.page)-1}}" ng-show="parseInt(book.page)&gt;0">Previous</a>
&nbsp;
<a href="#/search/{{book.query}}/{{parseInt(book.page)+1}}" ng-show="book.results &amp;&amp; book.results.length&gt;=book.pageSize">Next</a>
</td>
</tr>
</table>
</form>
